...
//may find applications in case of more than one device connected via USB
//Shows the details of connected devices
        ...
        for(UsbDevice device : usbManager.getDeviceList().values()) {
            ...
            if(driver != null) {
                ...
                {   listItems.add(new ListItem(device, port, driver));
                    ...
                    args.putInt("port", 0); // You can modify this if needed
