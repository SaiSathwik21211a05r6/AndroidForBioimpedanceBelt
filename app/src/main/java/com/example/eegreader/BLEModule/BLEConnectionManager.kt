...
//Handling BLE connection and communication
object BLEConnectionManager {
     ...
     */
    fun initBLEService(appContext: Context) {
        try {
            if (mBLEService == null) {
                val gattServiceIntent = Intent(appContext, BLEService::class.java)

                if (appContext != null) {
                    isBind = appContext.bindService(
                        gattServiceIntent,
                        mServiceConnection,
